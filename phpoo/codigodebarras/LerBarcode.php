...
<body>
    ...
    <form method="get">
        ...
        if(isset($_GET["produto"]) and isset($posicao)){
            ...
            echo "<strong>DESCRICAO:</strong> ".$produto->getDescricao()."<br><br>"; 
            echo "<strong>SKU:</strong> ".$produto->getSku()."<br><br>";
            echo "<strong>EAN:</strong> ".$produto->getEan(); 
            echo "<strong>VALORUNITARIO:</strong> ".$produto->getValorunitario()."<br><br>";  
